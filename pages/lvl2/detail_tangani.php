      ...
      <div class="container">
         <div class="row justify-content-center">
            ...
            <?php
               ...
               echo '<div class="row">';
                  echo '<div class="col">';
                     echo '<small>Dari: <strong>'.$data['PELAPOR'].'</strong></small>';
                  echo '</div>';
               echo '</div>';
               echo '<div class="row">';
                  echo '<div class="col">';
                     echo '<small>Ditangani sejak: <strong>'.$data['TGL_PENANGANAN'].'</strong></small>';
                  echo '</div>';
               echo '</div>';
               echo '<hr>';
               ...
               echo '</div>';
               echo '<div class="row">';
                  echo '<form action="../../scripts/lvl2/selesai-proses.php" method="post" style="padding:10px;">';
                     echo '<div class="form-group">';
                        echo '<label>Agar kerusakan dapat dikelompokkan berdasarkan jenisnya, pilih salah satu dari pilihan dibawah ini:</label>';
                        echo '<select class="form-control" name="jenis" required>';
                           echo '<option selected value="">-- Jenis --</option>';
                     ...
                     echo '<div class="col">';
                        echo '<button type="submit" name="submit" class="btn btn-warning btn-block" style="margin-top:10px;"><span class="fa fa-check"></span> Selesai</button>';
                     echo '</div>';
                  echo '</form>';
               echo '</div>';
            ?>
