   ...
   <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
               <li class="nav-item">
                  <a class="nav-link text-white mr-3" href="#"><span class="fa fa-envelope"></span> Pesan</a>
               </li>
               <li class="nav-item">
      ...
      <div class="container" style="margin-top: 55px;">
         ...
         <div class="row justify-content-center">
            <div class="col col-lg-3">
               <a href="laporan.php" id="laporan" target="targetContent" class="btn btn-primary btn-block">Laporan</a>
            </div>
            <div class="col col-lg-3">
               <a href="riwayat.php" id="riwayat" target="targetContent" class="btn btn-outline-primary btn-block">Riwayat</a>
            </div>
         </div>
         <div class="row justify-content-center">
            <div class="col col-lg-6">
      ...
      <script>
         ...
         $('#laporan').on('click', function(){
            $('#riwayat').removeClass('btn-primary');
            $('#laporan').removeClass('btn-outline-primary');
             $(this).addClass('btn-primary');
             $('#riwayat').addClass('btn-outline-primary');
         });

         $('#riwayat').on('click', function(){
            $('#laporan').removeClass('btn-primary');
            $('#riwayat').removeClass('btn-outline-primary');
             $(this).addClass('btn-primary');
             $('#laporan').addClass('btn-outline-primary');
         });
      </script>
   </body>
</html>
